...
class Player ():
    ...
    #     animation_process(self)

    #     my_spritesheet = Spritesheet('spritesheets/astronaute_anim.png')
    #     #pygame.image.load('MY_IMAGE_NAME.png').convert()
    #     # for i in range(len(self.idle_frames[])):
            
    #     self.idle_frames = [my_spritesheet.parse_sprite("astronaute_anim 1.png"),
    #                             my_spritesheet.parse_sprite("astronaute_anim 2.png"),
    #                             my_spritesheet.parse_sprite("astronaute_anim 3.png"),
    #                             my_spritesheet.parse_sprite("astronaute_anim 4.png"),]
